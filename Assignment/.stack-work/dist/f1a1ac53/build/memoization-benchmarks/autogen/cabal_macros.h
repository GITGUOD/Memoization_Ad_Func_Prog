...
/* package memoization-0.1.0.0 */
#ifndef VERSION_memoization
#define VERSION_memoization "0.1.0.0"
#endif /* VERSION_memoization */
#ifndef MIN_VERSION_memoization
#define MIN_VERSION_memoization(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_memoization */
...
/* package criterion-1.6.1.0 */
#ifndef VERSION_criterion
#define VERSION_criterion "1.6.1.0"
...
#define CURRENT_COMPONENT_ID "memoization-0.1.0.0-4YBTFydJvTAAjiEhyYMaCz-memoization-benchmarks"
